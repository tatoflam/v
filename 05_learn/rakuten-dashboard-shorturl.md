...
⚠️ 楽天 Web Service は 2026-02-10 に完全リニューアル済。**旧 endpoint と旧形式 applicationId は 2026-05-14 に完全停止**（本ページ初稿 2026-05-03 時点であと 11 日。account_1 (oheyamemo) 立上げ時に user 指摘で再確認、2026-05-07）。新 API は **UUID + accessKey + Origin** ヘッダ必須。
